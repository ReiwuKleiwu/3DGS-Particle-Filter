...
def camera_world_transform(
    ...
    if splat_map_xy_yaw is None:
        splat_map_xy_yaw = (DEFAULT_SPLAT_MAP_X, DEFAULT_SPLAT_MAP_Y, DEFAULT_SPLAT_MAP_YAW)
    splat_t_map = pose2d_to_matrix(*splat_map_xy_yaw)
...
def camera_entry(
    ...
    world_t_camera = camera_world_transform(pose, splat_map_xy_yaw)
    return {
        "id": img_name,
        "img_name": img_name,
        "width": camera.width,
