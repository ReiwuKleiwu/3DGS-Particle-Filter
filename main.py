...
from config_loader import load_turtlebot_localization_config
from particle_filter.application.localization_service import TurtleBotLocalizationService
...
from particle_filter.infrastructure.visualization.publisher import create_visualization_publisher
...
def main() -> None:
    ...
    renderer_client = SplatRendererClient(settings.renderer)
